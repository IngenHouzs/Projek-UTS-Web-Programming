                                        ...
                                        <div class="post-description p-1">
                                            ...
                                            <div class="post-reaction">
                                                <div class="post-like">
                                                    ...
                                                    <p class="mx-2"><?= $post['like']?></p>
                                                </div>
                                                <div class="post-comment">
                                                    <svg onclick="redirectToPostPage('<?=$post['id']?>')" class="button-comment" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--! Font Awesome Pro 6.2.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. -->
