                                ...
                                <section class="post-comments-wrapper">
                                    ...
                                    <div class="comment-box">
                                        ...
                                        <div class="user-comment-box">                                            
                                            ...
                                            <?php if(isset($_SESSION['ID_User'])) {?>
                                                <button onclick="likeComment('<?=htmlspecialchars($_SESSION['ID_User'])?>', '<?=htmlspecialchars($comment['comment_id'])?>')"><img src="../src/assets/like.png"/></button>                                                
                                            <?php }else{?>
                                                <button onclick="redirectToLoginPage()"><img src="../src/assets/like.png"/></button>
                                            <?php }?>
